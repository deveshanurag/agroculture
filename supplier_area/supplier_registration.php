...
<body>
    ...
    <main>
        <div class="banner">
            <div class="block">
        <div id="rform" class="">
                        <div class="heading" style="color:green" ><h1 >Buyer Registration</h1></div>
                ...
                <form action="" method="post" enctype="multipart/form-data">
                   ...
                   <!-- address -->
                    ...
                    <div class="text-center">
                        <input type="submit" value="Register" class="btn"name="supplier_register">
                    </div>
...
if(isset($_POST['supplier_register']))
{
    ...
    // select
    $select_query="Select * from `supplier_table` where supplier_username='$supplier_username' or supplier_email='$supplier_email'  ";
    ...
    // insert query
    move_uploaded_file($supplier_image1,"supplier_images/$supplier_image");
    $insert_query="Insert into `supplier_table`(supplier_username,supplier_email,supplier_password,supplier_image,supplier_address,supplier_contact)
