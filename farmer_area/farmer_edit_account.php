...
{
    $supplier_session_name= $_SESSION['f_username'];
    $select_query="Select * from `farmer_table` where farmer_username='$supplier_session_name'";
    $result_query=mysqli_query($con,$select_query);
    $row_fetch=mysqli_fetch_assoc($result_query);
    $supplier_id=$row_fetch['farmer_id'];
    $supplier_userrname=$row_fetch['farmer_username'];
    $supplier_email=$row_fetch['farmer_email'];
    $supplier_address=$row_fetch['farmer_address'];
    $supplier_contact=$row_fetch['farmer_contact'];
    

}
if(isset($_POST['farmer_update']))
{
    ...
    move_uploaded_file($userr_image_tmp,"./farmer_image/$userr_image");

    //update query
    $update_query="Update `farmer_table` set farmer_username='$userrname',farmer_email='$userr_email',farmer_image='$userr_image',
    farmer_address='$userr_address',farmer_contact='$userr_mobile' where farmer_id='$update_id'";
                ...
                <form action="" method="post" enctype="multipart/form-data">
                   ...
                   <!-- address -->
                    ...
                    <div class="text-center">
                        <input type="submit" value="Update" class="btn"name="farmer_update">
                    </div>
