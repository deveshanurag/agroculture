...
<body>
    ...
    <main>
        <div class="banner">
            <div class="block">
        <div id="rform" class="">
                        <div class="heading" style="color:green" ><h1 >Farmer Login</h1></div>
        ...
        <div >
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="text-center">
                        <input type="submit" value="Login" class="btn"name="farmer_login">
                    </div>
                    <p class="fw-bold">Don't have an account?  <a href="farmer_registration.php" class="" >Register</a> </p>
...
if(isset($_POST['farmer_login']))
{
    ...
    $select_login_query="Select * from `farmer_table` where farmer_username='$supplier_username'  ";
    ...
    {
        //session_start();
        $_SESSION['f_username']=$supplier_username;
        if(password_verify($supplier_password,$login_rows_data['farmer_password']))
        {
