...
<body>
    ...
    <main>
        <div class="banner">
            <div class="block">
        <div id="rform" class="">
                        <div class="heading" style="color:green" ><h1 >Admin Login</h1></div>
        ...
        <div >
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="text-center">
                        <input type="submit" value="Login" class="btn"name="admin_login">
                    </div>
                    <!-- <p class="fw-bold">Don't have an account?  <a href="admin_registration.php" class="" >Register</a> </p> -->
...
if(isset($_POST['admin_login']))
{
    ...
    $select_login_query="Select * from `admin_table` where admin_username='$supplier_username'  ";
    ...
    {
        //session_start();
        $_SESSION['a_username']=$supplier_username;
        if(password_verify($supplier_password,$login_rows_data['admin_password']))
        {
