...
<body>
    <header>
        ...
        <nav class="box">
            ...
            <div class="dropdown">
              ...
              <div class="dropdown">
                <button class="dropbtn" id="bt2"><a href="admin_login.php">Admin Login</a></button>
    ...
    <main>
        <div class="banner">
            <div class="block">
        <div id="rform" class="">
                        <div class="heading" style="color:green" ><h1 >Admin Registration</h1></div>
        ...
        <div >
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="text-center">
                        <input type="submit" value="Register" class="btn"name="admin_register">
                    </div>
                    <p class="fw-bold">Already have an account?  <a href="admin_login.php" class="" >Login</a> </p>
...
if(isset($_POST['admin_register']))
{
    ...
    // select
    $select_query="Select * from `admin_table` where admin_username='$supplier_username' or admin_email='$supplier_email'  ";
    ...
    // insert query
    move_uploaded_file($supplier_image1,"admin_image/$supplier_image");
    $insert_query="Insert into `admin_table`(admin_username,admin_email,admin_password,admin_image)
    values('$supplier_username','$supplier_email','$hash_password','$supplier_image')
    ";
